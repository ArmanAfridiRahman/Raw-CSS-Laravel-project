    ...
    <div class="settings-menu">
        ...
        <div class="add-settings-menu-form">
            ...
            <div class="settings-menu-form">
                <form action="{{route('settings.curriculum.update', ['id' => $curriculum->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <select class="select-form-control" required name="technology_id" >
                        ...
                        @foreach($technologies as $technology)
                            <option value="{{$technology->id}}" {{$technology->id == $curriculum->technology_id ? 'selected' : ''}}>{{$technology->technology_name}}</option>
                        @endforeach
                    </select>
                    <select  class="select-form-control"  required name="probidhan_id">
                        ...
                        @foreach($probidhans as $probidhan)
                            <option value="{{$probidhan->id}}" {{$probidhan->id == $curriculum->probidhan_id ? 'selected' : ''}}>{{$probidhan->probidhan}}</option>
                        @endforeach
                    </select>

                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Semester" value="{{$curriculum->semester}}" name="semester">
                    </div>
                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Link Address" value="{{$curriculum->links}}" name="links">
                    </div>
