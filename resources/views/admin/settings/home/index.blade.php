...
@section('content')
    <div class="settings-menu">
        ...
        <div class="add-settings-menu-form">
            ...
            <button class="new-settings-menu">Add a new home +</button>
            ...
            <div class="settings-menu-form">
                <form action="{{route('settings.home.save')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Home Tab Name" name="home_tabs">
                    </div>
                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Tab Description" name="home_tab_description">
                    </div>
                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Headline" name="home_headline_one">
                    </div>
                    <div class="description">
                        <textarea class="academic" name="home_description_one" placeholder="Description"></textarea>
                    </div>
                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Headline" name="home_headline_two">
                    </div>
                    <div class="description">
                        <textarea class="academic" name="home_description_two" placeholder="Description"></textarea>
                    </div>
                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Program Headline" name="home_programs">
                    </div>
