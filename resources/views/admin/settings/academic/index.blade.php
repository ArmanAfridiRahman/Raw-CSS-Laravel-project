...
@section('content')
    <div class="settings-menu">
        ...
        <div class="add-settings-menu-form">
            ...
            <button class="new-settings-menu">Add a new academic +</button>

            <div class="settings-menu-form">
                <form action="{{route('settings.academic.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="description">
                        <textarea class="academic" name="academic_information" placeholder="Add description"></textarea>
                    </div>
                    <div class="picture">
