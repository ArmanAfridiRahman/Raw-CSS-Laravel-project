    ...
    <div class="settings-menu">
        ...
        <div class="add-settings-menu-form">
            ...
            <div class="settings-menu-form">
                <form action="{{route('probidhan.update', ['id' => $probidhan->id])}}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Probidhan" value="{{$probidhan->probidhan}}" name="probidhan">
                    </div>
