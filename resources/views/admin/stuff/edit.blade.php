    ...
    <div class="settings-menu">
        ...
        <div class="add-settings-menu-form">
            ...
            <div class="settings-menu-form">
                <form action="{{route('stuff.update', ['id' => $stuff->id] )}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="heading">
                        <input type="text" class="form-control" value="{{$stuff->name}}" placeholder="stuff's Name" name="name">
                    </div>
                    <div class="heading">
                        <input type="text" class="form-control" value="{{$stuff->post}}" placeholder="Post Name" name="post">
                    </div>
                    <div class="heading">
                        <input type="text" class="form-control" value="{{$stuff->blood}}" placeholder="Blood Group" name="blood">
                    </div>
