    ...
    <div class="settings-menu">
        ...
        <div class="add-settings-menu-form">
            ...
            <div class="settings-menu-form">
                <form action="{{route('technology.update', ['id' => $technology->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="heading">
                        <input type="text" class="form-control" placeholder="Technology Name" value="{{$technology->technology_name}}" name="technology_name">
                    </div>
